...
The second step was to decide which visual design tool to use, i chose to use Figma as i like the simplicity and the areas of CSS code it offers and Figmas is a free alternative to Jira.
